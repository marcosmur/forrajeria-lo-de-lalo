      ...
      <section className="relative w-full h-[70vh] flex items-center justify-center text-center">
        ...
        <div className="z-10 text-white px-4">
          ...
          <p className="mt-4 text-xl md:text-2xl drop-shadow-lg">
            Alimentos, accesorios y más, con atención personalizada
          </p>
      ...
      <section className="py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <p className="text-center text-gray-700 mt-6 max-w-3xl mx-auto">
            Desde hace más de 10 años, brindamos productos y atención
            personalizada para el bienestar de tus mascotas y animales de
            granja. Somos una forrajería familiar comprometida con la calidad y
            la cercanía con nuestros clientes.
          </p>
          <p className="text-center text-gray-700 mt-6 max-w-3xl mx-auto">
            Nos destacamos por la atención personalizada, la confianza y la
            variedad de productos. Creemos en el trato cercano y en ayudar a
            nuestros clientes a encontrar exactamente lo que necesitan.
          </p>
          <p className="text-center text-gray-700 mt-6 max-w-3xl mx-auto">
            Te invitamos a conocernos en persona. Nuestro local está abierto
            todos los días con un equipo dispuesto a asesorarte y ayudarte a
            elegir lo mejor para tus animales.
          </p>
        </div>
      </section>
    </main>
